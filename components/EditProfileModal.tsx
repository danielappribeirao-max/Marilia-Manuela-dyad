...
interface EditProfileModalProps {
  user: User;
  onClose: () => void;
  onSave: (updatedUser: Partial<User>) => Promise<boolean>; // Alterado para Promise<boolean>
}
...
const EditProfileModal: React.FC<EditProfileModalProps> = ({ user, onClose, onSave }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
        ...
        // 3. Salva os dados e espera pelo resultado
        ...
        if (success) {
            ...
            // Se falhar, o UserDashboardPage já mostrou um alerta, mas garantimos o feedback
