...
import AdminManagePackages from './Admin/ManagePackages'; // Importado
...
type AdminTab = 'agenda' | 'reports' | 'services' | 'packages' | 'users' | 'notifications' | 'settings'; // 'packages' adicionado
...
const PackageIcon = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>; // Novo ícone para Pacotes
...
interface AdminDashboardPageProps {
    adminDataRefreshKey: number;
}

export default function AdminDashboardPage({ adminDataRefreshKey }: AdminDashboardPageProps) {
    ...
    const renderContent = () => {
        switch (activeTab) {
            case 'agenda': return <AdminAgenda key={adminDataRefreshKey} />;
            case 'reports': return <AdminReports />;
            case 'services': return <AdminManageServices />;
            case 'packages': return <AdminManagePackages />; // Novo
            case 'users': return <AdminManageUsers />;
            case 'notifications': return <AdminNotifications />;
            case 'settings': return <AdminSettingsPage />;
            default: return <AdminAgenda key={adminDataRefreshKey} />;
        }
    };
                    ...
                    <aside className="md:w-1/4 lg:w-1/5">
                        <div className="bg-white p-4 rounded-lg shadow-md">
                           <div className="space-y-2">
                               ...
                               <NavItem tab="packages" icon={<PackageIcon />} label="Pacotes"/> {/* Novo item */}
