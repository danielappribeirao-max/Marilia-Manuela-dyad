...
import AdminSettings from './Admin/Settings'; // Importar o novo componente
import { useApp } from '../App';
import { Role } from '../types';

type AdminTab = 'agenda' | 'reports' | 'services' | 'users' | 'notifications' | 'settings'; // Adicionar 'settings'
...
export default function AdminDashboardPage() {
    ...
    const renderContent = () => {
        switch (activeTab) {
            ...
            case 'settings': return <AdminSettings />; // Adicionar o novo caso
